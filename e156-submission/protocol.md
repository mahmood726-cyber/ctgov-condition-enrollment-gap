...
Protocol: CT.gov Condition Enrollment Gap

This protocol isolates missing actual enrollment inside condition-family CT.gov portfolios. An enrollment gap is an eligible older closed interventional study with missing actual enrollment. Primary outputs rank large condition families by enrollment-gap stock and rate using one condition-family label per study.
